...
export default function PortfolioPage() {
    ...
    return (
        <>
            <motion.nav 
                className={`fixed transition-all duration-700 z-30 ${
                    isScrolled && skillsSectionTop && window.scrollY >= skillsSectionTop 
                        ? 'top-20 border border-border/40 bg-background/75 backdrop-blur-sm shadow-sm' 
                        : 'top-20'
                }`}
                initial={{ opacity: 0, y: -20 }}
                animate={{ 
                    opacity: 1, 
                    y: 0,
                    left: isScrolled && skillsSectionTop && window.scrollY >= skillsSectionTop ? '1.5rem' : '50%',
                    x: isScrolled && skillsSectionTop && window.scrollY >= skillsSectionTop ? 0 : '-50%', 
                    borderRadius: "1.5rem",
                }}
                transition={{ 
                    type: "spring",
            ...
            >
                <div className="py-3 px-3">
                    ...
                    <div className="hidden md:flex justify-center">
                        <motion.ul 
                            className="flex space-x-1 rounded-xl"
                            ...
                            {["hero", "skills", "tech", "projects", "education", "experience", "contact"].map((item) => (
                                <li key={item}>
                                    <motion.a 
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="px-4 py-2 text-sm font-medium rounded-lg hover:text-primary transition-all block"
                                    >
                    ...
                    <div className="md:hidden flex justify-center">
                        <motion.button 
                            ...
                            className="p-3 rounded-xl transition-colors hover:bg-primary/10"
                ...
                <AnimatePresence>
                    {mobileMenuOpen && (
                        ...
                        >
                            <motion.ul 
                                className="py-3 px-4 space-y-1"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                transition={{ delay: 0.1, duration: 0.3 }}
                            >
                                {["hero", "skills", "tech", "projects", "education", "experience", "contact"].map((item, i) => (
                                    <motion.li 
                                        key={item}
                                    ...
                                    >
                                        <a 
                                            ...
                                            className="block py-2 px-4 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-center font-medium"
                                        >
                                            {item.charAt(0).toUpperCase() + item.slice(1)}
                                        </a>
                                    </motion.li>
